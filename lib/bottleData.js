...
export const BOTTLE_DATA = {
    'flasche1': {
        ...
        kapselPosition: { top: 9, left: 77, width: 66 },
        inhalt: {
        ...
        etikettKrümmung: { topCurve: -5, bottomCurve: 8 },
    ...
    'flasche3': {
        ...
        etikettKrümmung: { topCurve: -5, bottomCurve: 10 },
        shadowWidthAdjustment: 1.0,
        shadowSrc: '/images/shadow.png',
        blendMode: 'hard-light',
        allowedWines: ['blanco', 'rosado']
    ...
    'flasche7': {
        ...
        etikettKrümmung: { topCurve: -5, bottomCurve: 5 },
        shadowWidthAdjustment: 1.01,
        shadowSrc: '/images/shadow.png',
        blendMode: 'hard-light',
        allowedWines: ['blanco', 'rosado']
